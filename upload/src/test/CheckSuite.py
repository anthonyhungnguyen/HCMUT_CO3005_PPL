...
class CheckSuite(unittest.TestCase):
    ...
    def test_mismatchexp_compare_boolean(self):
        input = """
        void main() {
           boolean a;
    ...
    def test_mismatchexp_equal_different_type(self):
        input = """
        void main() {
           boolean a;
           a = true == 1;
    ...
    def test_function_return_in_for(self):
        input = """
        int main(int a) {
           for(a=1;a<10;a=a+1)
                return 5;
    ...
    def test_mismatchexp_compare_numbers(self):
        input = """
        void main() {
           boolean a;
            a = 5 < 7;
    ...
    def test_mismatchexp_mod_float_int(self):
        input = """
        void main(int a) {
           a = 20 % 2.2;
        }
        """
        expect = "Type Mismatch In Expression: BinaryOp(%,IntLiteral(20),FloatLiteral(2.2))"
        self.assertTrue(TestChecker.test(input, expect, 479))

    def test_mismatchexp_mod_many_ints(self):
        input = """
        void main(int a) {
    ...
    def test_mismatchexp_mod_many_ints1(self):
        input = """
        int foo() {
    ...
    def test_other_simple_not_left_value(self):
        input = """
        void main() {
            true = 1.1
        }
    ...
    def test_builtin_String_func(self):
        input = """
        void main() {
            putString("aaa");
        }
