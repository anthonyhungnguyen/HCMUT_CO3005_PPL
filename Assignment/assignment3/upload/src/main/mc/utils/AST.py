...
class BinaryOp(Expr):
    ...
    def __str__(self):
        return "BinaryOp(" + self.op + "," + str(self.left) + "," + str(
            self.right) + ")"
...
class CallExpr(Expr):
    ...
    def __str__(self):
        return "CallExpr(" + str(self.method) + ",[" + ','.join(
...
class If(Stmt):
    ...
    def __str__(self):
        return "If(" + str(self.expr) + "," + str(self.thenStmt) + ("" if (
            self.elseStmt is None) else "," + str(self.elseStmt)) + ")"
...
class For(Stmt):
    ...
    def __str__(self):
        return "For(" + str(self.expr1) + ";" + str(self.expr2) + ";" + str(
            self.expr3) + ";" + str(self.loop) + ")"
...
class Return(Stmt):
    ...
    def __str__(self):
        return "Return(" + ("" if
                            (self.expr is None) else str(self.expr)) + ")"
...
class Dowhile(Stmt):
    ...
    def __str__(self):
        return "Dowhile([" + ','.join(str(i) for i in self.sl) + "]," + str(
            self.exp) + ")"
...
class FuncDecl(Decl):
    ...
    def __str__(self):
        return "FuncDecl(" + str(self.name) + ",[" + ','.join(
            str(i) for i in self.param) + "]," + str(
